...
def load_labels(path='C:/Users/Besitzer/OneDrive/Desktop/model/label_map.pbtxt'):
...
def main():
    labels = load_labels()
    interpreter = Interpreter('C:/Users/Besitzer/OneDrive/Desktop/model/detect.tflite')
